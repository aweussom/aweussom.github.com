...
Slug: i-got-tired-of-guessing-my-claude-quota-so-i-made-a-robot-read-it-for-me
Tags: claudecode, python, powershell
Summary: Update: MUCH less crazy way of displaying...
Original: https://dev.to/tommy_leonhardsen_81d1f4e/i-got-tired-of-guessing-my-claude-quota-so-i-made-a-robot-read-it-for-me-3513

## Update: MUCH less crazy way of displaying quota

[https://github.com/aweussom/claude-code-quota](https://github.com/aweussom/claude-code-quota)
...
![Image description]({static}/images/i-got-tired-of-guessing-my-claude-quota-so-i-made-a-robot-read-it-for-me/01.png)
...
1. **It has a free tier (for now)** — Ollama Cloud gives you access to massive models without paying per token (still requires an API key, and "free" is famously a temporary condition on the internet)
...
Local Ollama example (recommended if you're privacy-paranoid. Well. Actually, recommended anyways. Automatically sending screenshots to the internet is bound to create interesting incidents some way down the line):
...
The catch: Chrome integration is not supported in WSL, so you'd run this from Claude Code on Windows. 

Even Claude finds this amusing: 

![Image description]({static}/images/i-got-tired-of-guessing-my-claude-quota-so-i-made-a-robot-read-it-for-me/02.png)
